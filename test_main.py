...
def test_satisfiable_brute_simple_tautologi():
    p = Disjunction(Atomic("A"), Negation(Atomic("A")))
    assert satisfiable_brute(p) == True


def test_satisfiable_brute_simple_contradiction():
    p = Conjunction(Atomic("A"), Negation(Atomic("A")))
    assert satisfiable_brute(p) == False


def test_satisfiable_brute_complex_contradiction():
    A = Atomic("A")
    B = Atomic("B")
    C = Atomic("C")
    ...
    assert satisfiable_brute(not_p) == False


def test_satisfiable_brute_complex_single_solution():
    A = Atomic("A")
    B = Atomic("B")
    C = Atomic("C")
    ...
    assert satisfiable_brute(not_p) == True
